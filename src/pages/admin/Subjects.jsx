    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Mata Pelajaran</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Manajemen kurikulum, Jurusan, dan Pengampu Mata Pelajaran.</p>
                </div>
                <button
            ...
            <div className="relative max-w-md">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none transition-all shadow-sm text-gray-700 dark:text-gray-200"
                    value={searchTerm}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredSubjects.map((subject) => (
                    <div key={subject.id} className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-xl dark:shadow-black/20 transition-all group overflow-hidden relative flex flex-col h-full">
                        ...
                        <div className="flex items-start justify-between mb-6 relative z-10">
                            <div className={`p-4 rounded-2xl bg-${subject.color}-50 dark:bg-${subject.color}-900/30 text-${subject.color}-600 dark:text-${subject.color}-400 transition-transform group-hover:scale-110 shadow-sm border border-${subject.color}-100 dark:border-${subject.color}-900/40`}>
                                <BookOpen size={24} />
                            </div>
                        ...
                        <div className="relative z-10 flex-1 flex flex-col">
                            <h3 className="text-lg font-black text-gray-900 dark:text-gray-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors uppercase tracking-tight">{subject.name}</h3>

                            <div className="flex items-center space-x-2 mt-1">
                                <span className="px-2 py-0.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 text-[10px] font-black uppercase tracking-widest border border-gray-200 dark:border-gray-700">
                                    {subject.jurusan}
                                </span>
                            </div>
                            ...
                            <div className="mt-4 flex-1 space-y-2">
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {subject.teachers ? subject.teachers.split(', ').map((teacher, idx) => (
                                        <span key={idx} className="text-[11px] font-bold text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 px-2 py-1 rounded-lg border border-gray-100 dark:border-gray-700">
                                            {teacher}
                                        </span>
                                    )) : <span className="text-[11px] text-gray-400 dark:text-gray-600 italic">Belum ada guru</span>}
                                </div>
                            </div>

                            <div className="mt-6 flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 group-hover:bg-white dark:group-hover:bg-gray-800 transition-colors">
                                <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
                                    <Target size={16} className="text-emerald-500" />
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em]">KKM minimal</span>
                                </div>
                                <span className="text-2xl font-black text-emerald-600 dark:text-emerald-400">{subject.kkm}</span>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            >
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Nama Mata Pelajaran</label>
                        <input
                            required
                            type="text"
                            className="w-full bg-gray-50 dark:bg-gray-800 border-transparent rounded-xl px-4 py-3 font-bold text-gray-700 dark:text-gray-200 outline-none transition-all focus:bg-white dark:focus:bg-gray-800 focus:border-emerald-500 border-2"
                            value={formData.name}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">KKM</label>
                            <input
                                required
                                type="number"
                                className="w-full bg-gray-50 dark:bg-gray-800 border-transparent rounded-xl px-4 py-3 font-bold text-gray-700 dark:text-gray-200 outline-none transition-all focus:bg-white dark:focus:bg-gray-800 focus:border-emerald-500 border-2"
                        ...
                        <div className="space-y-1">
                            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Warna Ikon</label>
                            <div className="relative">
                                <select
                                    className="w-full bg-gray-50 dark:bg-gray-800 border-transparent rounded-xl px-4 py-3 font-bold text-gray-700 dark:text-gray-200 outline-none transition-all focus:bg-white dark:focus:bg-gray-800 focus:border-emerald-500 border-2 appearance-none"
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Jurusan (Ketik Baru atau Pilih)</label>
                        <div className="relative">
                            <input
                                list="jurusan-list"
                                type="text"
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Guru Pengampu (Bisa Pilih Banyak)</label>
                        <div className="max-h-48 overflow-y-auto bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border-2 border-transparent focus-within:bg-white dark:focus-within:bg-gray-800 focus-within:border-emerald-500 transition-all space-y-2 no-scrollbar">
                            {dbTeachers.map(teacher => (
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between p-3 rounded-xl transition-all font-bold text-xs ${formData.teachers.includes(teacher.name)
                                        ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-100 dark:shadow-black/20 scale-[1.02]'
